...
class DeviceStatusReporter:
    ...
    def check_and_report(self):
        ...
        for device_id, total_power in live_power_data.items():
            # Ensure total_power is not None before comparison
    ...
    def run(self):
        ...
        # UPDATED CODE: Add a startup delay to allow the getData thread to poll first.
        startup_delay = 20  # seconds
        self.logger.info(f"Waiting for a {startup_delay}-second grace period before the first status check...")
