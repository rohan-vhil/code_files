'''Handling NaN in Data Reporting
https://gemini.google.com/share/face8b054488

The problem occurs because the standard JSON specification does not recognize NaN
(Not a Number) as a valid data type.'''
