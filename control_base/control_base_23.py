'''Understanding Modbus Data Scaling Factors
https://gemini.google.com/share/830e0e79e8ea

--with Updated Time_of_Use function--
I have added the addition_factor to the dataModel, updated createMapForVar
to extract it from your JSON,
and modified getData to perform the final addition after the multiplication/scaling.
I also updated the encode method to subtract the factor before sending data back to the device'''
