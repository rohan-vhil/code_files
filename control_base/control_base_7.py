'''To round the component data to two decimal places, you only need to modify the getAllData function in your main script. The change involves using Python's built-in round() function on the value before assigning it to the final dictionary.

Your second script for averaging and sending data does not need any changes.

Here is the complete updated code for your main script.'''
