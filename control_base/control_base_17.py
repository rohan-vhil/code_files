'''Of course. I've updated the getAllData function to omit the total_energy
field from the final JSON output if its value is zero.
The logic for managing the persistent log file remains
the same to ensure continuity on restart.'''
