'''
-----Modify `getAllData` Function Logic-----

It looks like you want to modify the getAllData function
in your control_base.py to handle the total_power value
for devices whose ID contains 'HT'. Specifically,
if the total_power is negative for an 'HT' device,
you want to make it positive by multiplying it by -1'''
