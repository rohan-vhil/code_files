...
class modbusTCPDevice(ctrl.systemDevice):
    ...
    def close_connection(self):
        ...
        try:
            # Removed the is_socket_open() check to force the close command through
    ...
    def hard_reset(self):
        ...
        try:
            ...
            pass
        self.device_connected = False
        # Completely re-instantiate the client to wipe the internal framer state and transaction IDs
