'''You want to print the list of raw register data (data[-1]) along with the specific device_id inside the getData function of modbusmasterapi.py.

The device_id is an attribute of the device object passed to getData'''
...
def getData(addrmap:dict,device:Union[modbusRTUDevice, modbusTCPDevice]):
    ...
    try:
        for block in addrmap:
            ...
            # START OF UPDATED PRINT STATEMENT
