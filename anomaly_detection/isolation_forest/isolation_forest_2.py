...
CONTAMINATION = 0.05     # Expected percentage of anomalies (e.g., 5%)
...
# Change these to run on BESS, Meters, or WMS without changing the core logic.
...
def extract_dynamic_features(payload):
    ...
    for device_id, data in payload.items():
        # Only process devices that match our filter
...
if __name__ == "__main__":
    ...
    # A base payload simulating your actual JSON structure
    raw_json_string = """
    {
