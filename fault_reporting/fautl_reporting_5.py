...
class FaultProcessor:
    ...
    def _send_faults_to_api(self, payload: list):
        ...
        try:
            ...
            logging.info(f"Successfully sent {len(payload)} new faults to API.")
    ...
    def run(self):
        ...
        while self._running:
            try:
                ...
                if new_faults_payload:
                    self._send_faults_to_api(new_faults_payload)
