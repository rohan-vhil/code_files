'''I have updated the fault_reporting.py script to fix this.
It will now create and send a "Fault Cleared" message specifically
when a device's fault code changes from any non-zero value to 0.
It will continue to ignore devices that are persistently 0'''
        ...
        while self._running:
            ...
            try:
                ...
                for device_id, fault_dict in fault_data.items():
                    ...
                    # **MODIFIED BLOCK TO SEND CLEARED FAULTS**
