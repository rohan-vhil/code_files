        ...
        while self._running:
            ...
            try:
                ...
                for device_id, fault_dict in fault_data.items():
                    # FIX #1: Extract the integer fault code from the dictionary
                    fault_code = fault_dict.get('fault', 0)

                    # FIX #2: Extract the part number from the full device_id
                    ...
                    if fault_code != 0 and fault_code != last_code:
                        ...
                        # FIX #3: Use the correct 'part_num' for the lookup
