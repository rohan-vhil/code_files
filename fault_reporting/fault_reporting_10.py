        ...
        while self._running:
            ...
            try:
                ...
                for device_id, fault_code in fault_data.items():
                    print(f"\n--- FaultProcessor: > Checking device '{device_id}' | Received Code: {fault_code}")
                    ...
                    if fault_code != 0 and fault_code != last_code:
                        ...
                        if not device_config:
                            print(f"--- FaultProcessor: > Warning: No 'Fault' definition found for device '{device_id}' in error_codes.json")
                            continue
                    ...
                    elif fault_code == 0 and last_code != 0 and last_code is not None:
