...
https://gemini.google.com/share/1da7cfbc5dba

Here is the updated code with isValidJson modified to check only for the existence
of mode and op_details, with all comments removed'''
...
def isValidJson(json_string):
    try:
        ...
        if not isinstance(data, dict):
            return False
        if "mode" in data or "op_details" in data:
            return True
        return False
